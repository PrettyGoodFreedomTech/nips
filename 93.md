...
## List curation and spam prevention
 ...
 _This NIP is agnostic regarding the choice of method or methods for list curation and spam prevention_. This NIP presumes that a wide variety of methods exist with varying degrees of sophistication and will be specified elsewhere. For example, a _personalized trust metric_ could be used to exclude items based on the personalized trust metric of the item contributor. The purposes of such methods may include:
