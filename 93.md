...
The `z` tag is required and defines the category or categories to which the kind `9999` note belongs. It must be a string, and can be either human readable or an event id. There can be multiple z-tags.
