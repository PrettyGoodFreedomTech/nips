...
There are two actions: declaration of a list, and declaration of a specific item that belongs to a given list. We use kind `9999` (or `39999`) for each of these actions.
